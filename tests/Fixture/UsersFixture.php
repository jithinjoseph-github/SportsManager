...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '0=Club Manager, 1=Match Organizer, 2=Coach, 3=Player', 'precision' => null],
        ...
        '_indexes' => [
            'FK_users_clubs' => ['type' => 'index', 'columns' => ['club_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role' => 1,
                'club_id' => 1,
                'created' => '2021-06-28 13:58:03',
                'modified' => '2021-06-28 13:58:03',
            ],
        ];
        parent::init();
    }
